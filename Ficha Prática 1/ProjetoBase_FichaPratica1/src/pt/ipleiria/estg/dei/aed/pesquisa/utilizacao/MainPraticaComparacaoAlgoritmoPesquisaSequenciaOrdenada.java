 ...
 */
public class MainPraticaComparacaoAlgoritmoPesquisaSequenciaOrdenada {
    private static final int TAMANHO = 1000;
    private static final int NUMERO_EXECUCOES = 20;

    public MainPraticaComparacaoAlgoritmoPesquisaSequenciaOrdenada() {
    ...
    public static void main(String[] args) {
        new MainPraticaComparacaoAlgoritmoPesquisaSequenciaOrdenada();
    }
